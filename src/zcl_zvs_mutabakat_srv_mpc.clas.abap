class ZCL_ZVS_MUTABAKAT_SRV_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_MUTABAKAT,
     CURRENCY type C length 5,
     AMOUNT type string,
     CUSTOMERNAME type C length 80,
     RECON_ID type C length 10,
     RECON_SPGL_IND type C length 1,
     RECON_DATE type C length 10,
     CUSTOMER_ID type C length 10,
     RECON_COMPANY_ID type C length 4,
     RECON_STATE type C length 1,
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZVS_MUTABAKAT_SRV_MPC=====CP' ##NO_TEXT.
...
CLASS ZCL_ZVS_MUTABAKAT_SRV_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVS_MUTABAKAT_SRV_SRV' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ReconId' iv_abap_fieldname = 'RECON_ID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ReconSpglInd' iv_abap_fieldname = 'RECON_SPGL_IND' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ReconCompanyId' iv_abap_fieldname = 'RECON_COMPANY_ID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ReconState' iv_abap_fieldname = 'RECON_STATE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZVS_MUTABAKAT_SRV_MPC=>TS_MUTABAKAT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260417034713'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'ReconId'.                 "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'ReconSpglInd'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Mutabakat'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ReconDate'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Mutabakat'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ReconCompanyId'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Mutabakat'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ReconState'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Mutabakat'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
